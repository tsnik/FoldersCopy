...
public class DoubleProgressDialog extends AlertDialog {
    ...
    private String mSecondaryProgressNumberFormat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewUpdateHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                format = mSecondaryProgressNumberFormat;
        ...
        mProgressNumberFormat = "%d KB/%d KB";
        mSecondaryProgressNumberFormat = "%d/%d";
